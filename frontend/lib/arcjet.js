...
// Free tier AI Chef questions (5 per Clerk session)
// We key by `sessionId` so a new login session resets the bucket.
export const freeAiChefQuestions = aj.withRule(
  tokenBucket({
    mode: "LIVE",
